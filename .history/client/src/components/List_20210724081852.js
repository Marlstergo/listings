    ...
    >
      <div className="w-10/12 ">
        <h1 className="text-gray-600 py-6 text-4xl">List of all Users</h1>
          ...
          <p className={`${allEmployees.length? 'block' : 'hidden'}text-lg`} > There is no user on the data base. Add user </p> 
        
        <table className="min-w-full divide-y divide-gray-200 table-fixed">
        <p className={`${allEmployees.length? 'block' : 'hidden'}text-lg p-5`} > There is no user on the data base. Add user </p> 
          <thead>
            <tr>
