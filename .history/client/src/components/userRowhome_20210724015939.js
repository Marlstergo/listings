    ...
    <tr>
      ...
      <td className=" flex justify-between ">
        ...
        <span className=" space-x-2 flex">
          ...
          <button className="border-2 rounded-lg bg-red-500 active:bg-red-800 px-1" onClick={() => {deleteEmployees(id)}}>delete</button>
        </span>
      </td>
    </tr>
  );
...
export default connect( mapDispatchToProps)(UserRowHome);
